...
const Doprava = () => {
  return (
    <>
      <main className="px-8 mb-20 mt-36">
        <h1 className="mb-3 text-3xl font-medium text-center md:text-6xl text-primary">Doprava</h1>
        <p className="max-w-4xl mx-auto mb-24 text-2xl font-light text-center md:text-3xl md:mb-24">Váš stavebný materiál Vám radi dopravíme a aj vyložíme našími nákladnými autami na Vami požadované miesto a termínom dodania.</p>
        <section className="grid w-full grid-cols-1 gap-24 md:gap-16 md:grid-cols-2 xl:grid-cols-3">
          {truckList.map((truck) => (
            <div key={truck.title} className="relative gap-10 px-5 bg-gray-100 rounded-lg md:flex-row">
